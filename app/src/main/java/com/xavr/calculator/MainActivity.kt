...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_equal.setOnClickListener{setTextFields("=")}
        ...
        btn_equal.setOnClickListener {
            try {
                var ex = ExpressionBuilder(math_operation.text.toString()).build()
                ...
                Log.d("ERROR", "Message Equal function: ${e.message}")
            }
        }
